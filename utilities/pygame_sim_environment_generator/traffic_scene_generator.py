...
print "2) Now as you move the mouse, the car will rotate, click again to fix the initial orientation of the autonomous car"
...
ROAD_DATA_FILE_NAME = raw_input("Enter the name for environment/road data file (without file extension): ")
...
if __name__ == "__main__":
    ...
    print "Click anywhere inside the roads to place the autonomous car\n"

    # Get start pose for the autonomous car
